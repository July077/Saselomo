...
<div class="modal-header">
	...
	<h4 class="modal-title">批量导入客户信息</h4>
</div>
<div class="modal-body">
	<form class="form-inline col-md-offset-1" method="post" enctype="multipart/form-data">
		...
		<input id="excelClient" type="file" name="mFile">  
	</form>
</div>
<div class="modal-footer">
	<div class="col-md-4">
		<a href="client/downloadExcelTemplate.do">
...
<!-- 客户信息导入js -->
<script type="text/javascript" src="${basePath }/js/client/client_importModal.js"></script>